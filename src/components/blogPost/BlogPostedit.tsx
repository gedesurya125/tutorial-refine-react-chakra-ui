...
export const BlogPostEdit: React.FC<IResourceComponentsProps> = () => {
  ...
  console.log("this is the date containt", {
    date: register("createdAt", {
  ...
  return (
    <Edit isLoading={formLoading} saveButtonProps={saveButtonProps}>
      ...
      <FormControl mb="3" isInvalid={!!(errors as any)?.createdAt}>
        ...
        {/* <MyDatePicker register={register} /> */}
        <Input
          {...register("createdAt", {
            required: "This field is required",
          })}
...
// const MyDatePicker = ({ register }) => {
//   const dateProps = register("createdAt", {
//     required: "This field is required",
//   });

//   console.log("this is the date props", dateProps.ref);

//   // return <Input type="date" aria-label="Date" value={1} {...dateProps} />;
